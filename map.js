...
let map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/oyyc/cjnq973wx0uol2spl8asu1plr',
...
geolocate.on('geolocate', function(event) {
    // get the library from the layer data
    let features = map.queryRenderedFeatures({ layers: ['library'] })
    ...
    document.getElementById('info').innerHTML = 'Distance to the nearest library:'+closest_distance.toFixed(3)+'km'
